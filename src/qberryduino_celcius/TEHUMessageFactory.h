...
//  includes a function to create "Current State" message for TEHU
//  (Temperature and Humidity) using the declared version in local
//  variable named PROTOCOL_VERSION located on the inherited class.
